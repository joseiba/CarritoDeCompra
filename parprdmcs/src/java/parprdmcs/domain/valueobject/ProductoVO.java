package parprdmcs.domain.valueobject;
...
public class ProductoVO {
     ...
     * @param tipoCliente
     */
    public ProductoVO(String id, String nombre, String apellido, String email, String loginName, String passwd, int tipoCliente) {
        this.id = id;
        this.nombre = nombre;
