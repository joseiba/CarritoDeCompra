...
public class ServletHome extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("Accion del home:" + accion);
        
        switch(redireccion) {
            case "listarCliente.jsp" :
                rd = request.getRequestDispatcher("/ServletCliente");
                rd.forward(request, response);
                break;
            case "listarProducto.jsp" :
                rd = request.getRequestDispatcher("/ServletProducto");
                rd.forward(request, response);
                break;
            case "login.jsp" :
